...
<div class="header">
  ...
  <h1>Pumitas Prime - HACKODS UNAM</h1>

  <h2>Correlaciones entre ODS</h2>

  <p>
  Educación (4), trabajo decente (8), industria e innovación (9), 
  desigualdad (10) y ciudades (11)
  </p>

   <p class="header-meta-row">
    <span>Equipo: Tu equipo</span>
...
::: {.column width="40%"}
::: {.custom-box}
La evidencia aquí es **asociativa** (correlación): sirve para **priorizar** y **dialogar en gabinete**; la **causalidad** se aborda con evaluaciones y diseños empíricos posteriores. 
:::
:::
...
::: callout-note
Los valores del archivo `data/indicadores_ods_demo.csv` son **ilustrativos** (montados para el hackathon). Para el entregable final, se sustituirán por series oficiales desde [agenda2030.mx](https://agenda2030.mx) / INEGI, con el mismo formato de columnas, el avance homologado se encuentra en `data/indicadores_ods.csv`.
:::
...
<br/><sub>Empleo, productividad, informalidad<br><br></sub>
</td>
<td width="20%" align="center">
...
<br/><sub>I+D, manufactura, tecnología<br><br></sub>
</td>
<td width="20%" align="center">
...
<br/><sub>Ingreso, pobreza relativa<br><br></sub>
</td>
<td width="20%" align="center">
...
<br/><sub>Vivienda y entorno urbano<br><br></sub>
</td>
</tr>
</table>
...
C["ODS 9<br/>Industria e innovación"]
D["ODS 10<br/>Reducción de desigualdad"]
E["ODS 11<br/>Ciudades sostenibles"]
...
%% ----- ESTILOS ODS -----
style A fill:#C5192D,color:#fff,stroke:#333,stroke-width:1px
style B fill:#A21942,color:#fff,stroke:#333,stroke-width:1px
style C fill:#FD6925,color:#fff,stroke:#333,stroke-width:1px
style D fill:#DD1367,color:#fff,stroke:#fff,stroke-width:1px
style E fill:#FD9D24,color:#fff,stroke:#333,stroke-width:1px

%% ----- MATRIZ -----
style M fill:#f5f5f5,color:#333,stroke:#999,stroke-dasharray: 5,5
```
...
## 🔍 Análisis territorial interactivo

Este módulo complementa el análisis principal explorando la relación entre educación (ODS 4) y empleo informal (ODS 8) a nivel estatal.

<div style="text-align: center; margin-top: 20px;">
  <a href="correlacion8y4.html">
    <button style="
      padding: 12px 24px;
